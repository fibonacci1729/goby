...
func TestRipperInstructionFail(t *testing.T) {
	testsFail := []errorTestCase{
		...
		{`require 'ripper'; Ripper.instruction(1)`, "TypeError: Expect argument to be String. got: Integer", 1},
		{`require 'ripper'; Ripper.instruction(1.2)`, "TypeError: Expect argument to be String. got: Float", 1},
		{`require 'ripper'; Ripper.instruction(["puts", "123"])`, "TypeError: Expect argument to be String. got: Array", 1},
		{`require 'ripper'; Ripper.instruction({key: 1})`, "TypeError: Expect argument to be String. got: Hash", 1},
	}
